...
function VirtualSky(input){
	...
	this.magnitude = 9;					// Plante edited, Limit for stellar magnitude
	...
	this.file = {
		stars: "./json/stars.json",                 // Plante edited, Data for faint stars - 54 kB
	...
	// plante_poi_2_5
		...
		surveys: "./json/surveydatasurveys.json",		  // Data for survey boundaries
...
VirtualSky.prototype.createSky = function(){
   ...
   // plante_poi                                                           
   	...
   	// Get the survey line data
	//if(!this.surveys) this.load('surveys',this.file.surveys);
...
VirtualSky.prototype.drawStars = function(){
	...
	var star_zoom_scale = f*5;  //Plante edited
	this.magnitude = star_zoom_scale;  //Plante edited
